...
export const projects = [
  {
    title: 'KukuConnect',
    subtitle: 'Your kuku partner',
    desc: 'A modern poultry platform helping farmers track, manage and grow their operations efficiently.',
    category: 'SaaS / Poultry Tech',
    tags: ['Next.js', 'FastAPI', 'PostgreSQL', 'Mobile'],
    status: 'Research Active',
    github: 'https://github.com/derickmokua/Kukuconnect-FMS',
    demo: 'https://kukuconnect.co.ke',
  },
  {
    title: 'KukuConnect FMS',
    subtitle: 'Farm management system',
    desc: "The backend behind KukuConnect, built to keep working when the network doesn't.",
    category: 'Backend / Offline-first',
    tags: ['FastAPI', 'PostgreSQL', 'Offline-first'],
    status: 'Production',
    github: 'https://github.com/derickmokua/Kukuconnect-FMS',
    demo: null,
  },
  {
    title: 'Saibae',
    subtitle: 'Everyday AI on WhatsApp',
    desc: 'An AI-powered WhatsApp assistant for everyday needs.',
  ...
  {
    title: 'WhatsLove',
    subtitle: 'Conversations that connect',
    desc: 'A conversational product connecting people in real time.',
    category: 'Conversational Product',
    tags: ['Django', 'APIs', 'Real-time'],
    status: 'Production',
    github: null,
    demo: null,
  },
  {
    ...
    subtitle: 'Vote, count, share',
    desc: 'A poll platform for creating, sharing and counting votes reliably.',
