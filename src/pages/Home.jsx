          ...
          <footer className="border-t border-terminal-green/10 pt-8 text-[10px] text-terminal-muted font-mono flex flex-col items-center gap-5 select-none pb-10">
            ...
            <div className="flex items-center gap-5">
              ...
              <a
                ...
                rel="noopener noreferrer"
                title="X (Twitter)"
                className="text-terminal-muted hover:text-white hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] transition-all duration-300"
              >
                {/* Real X logo */}
              ...
              <a
                ...
                rel="noopener noreferrer"
                title="LinkedIn"
                className="text-terminal-muted hover:text-[#0077b5] hover:drop-shadow-[0_0_8px_rgba(0,119,181,0.8)] transition-all duration-300"
              >
                <Linkedin size={16} />
              </a>
              {/* WhatsApp */}
              <a
                ...
                rel="noopener noreferrer"
                title="WhatsApp"
                className="text-terminal-muted hover:text-[#25D366] hover:drop-shadow-[0_0_8px_rgba(37,211,102,0.8)] transition-all duration-300"
              >
